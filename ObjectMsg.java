...
public class ObjectMsg {
	...
	public ObjectMsg(int mode, String id, String message, ImageIcon Image, long size, long room) {
		this.mode = mode;
		this.Image = Image;
